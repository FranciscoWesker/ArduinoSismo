...
PFont f6,f8,f12,f10;
PFont f24;
Serial myPort; // El puerto del serial
int xPos = 0; // posicision horizontal de la grafica
float y1=0;
float y2=0;
float y3=0;
...
void setup ()
{
// El tamaño de la grafica y de la letra
...
void serial()
{
String inString = myPort.readStringUntil('$'); // leyendo la fecha entrante de la serie
if (inString != null)
{
//Extreaer todos los valores requeridos de los tres ejes:
...
//mapeo de valores x, y y z con dimensiones gráficas
...
//trazando los valores x y y z sobre el gráfico
strokeWeight(2);
int shift=40;
...
if (x >= width-30)// volver al principio
{
xPos = 0;
background(80);
}
